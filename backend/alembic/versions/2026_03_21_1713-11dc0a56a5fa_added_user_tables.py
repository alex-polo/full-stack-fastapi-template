...
Revision ID: 11dc0a56a5fa
Revises: 
Create Date: 2026-03-21 17:13:17.188480
...
def upgrade() -> None:
    ...
    op.create_table("association_role_permissions",
    sa.Column("role_id", sa.Integer(), nullable=False),
    sa.Column("permission_id", sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(["permission_id"], ["auth_permissions.id"], name=op.f("fk_association_role_permissions_permission_id_auth_permissions"), ondelete="CASCADE"),
    sa.ForeignKeyConstraint(["role_id"], ["auth_roles.id"], name=op.f("fk_association_role_permissions_role_id_auth_roles"), ondelete="CASCADE"),
    sa.PrimaryKeyConstraint("role_id", "permission_id", name=op.f("pk_association_role_permissions"))
    )
    ...
    sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
    sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
    sa.ForeignKeyConstraint(["role_id"], ["auth_roles.id"], name=op.f("fk_user_role_assignments_role_id_auth_roles"), ondelete="CASCADE"),
